// addicon with user symbol

export const AddPersonicon = ({ setData, value }) => {
  return (
    <span
...
// delete icon
export const DeleteIcon = ({ setDelId, value }) => {
  return (
    <span
      className="btn btn-primary btn-icon btn-sm rounded-pill"
      onClick={setDelId}
      role="button"
    >
      <span className="btn-inner" onClick={setDelId}>
        <svg
        onClick={setDelId}
          width="32"
          viewBox="0 0 24 24"
...
export const EditIcon = ({ setData }) => {
  return (
    // eslint-disable-next-line jsx-a11y/anchor-is-valid
    <a className="btn btn-primary btn-icon btn-sm rounded-pill">
