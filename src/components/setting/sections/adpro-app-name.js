...
import SettingAction from '../../../Redux/setting/actions'
    ...
    return (
        <Fragment>
            ...
            <OverlayTrigger placement="right" overlay={
                ...
                <span>
                    <svg width="20" className="icon-20" height="20" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
